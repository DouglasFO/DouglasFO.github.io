...
function teste(){
    ...
    textnode = document.createTextNode(texto1.value);
...
elemento2 = document.getElementById("lampada");
elemento2.addEventListener('click',lampada,false);
